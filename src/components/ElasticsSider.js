...
const ElasticSlider = () => {
  ...
  return (
    <div style={{ display: 'flex', marginLeft: '5rem' }}>
      <div className='flex items justify-center inline-block' style={{ display: 'flex', alignItems: 'center', margin: '5rem 2.5rem', height: '15rem', background: 'rgba(128, 128, 215, 0.25)', borderRadius: '2.3125rem' }}>
      ...
      <div style={{ margin: '2.5rem 5rem' }}>
        <p style={{ color: 'white', fontSize: '1.25rem', fontFamily: 'Roboto', fontWeight: '400', wordBreak: 'break-word' }}>OUR SHGs</p>
        <p style={{ color: 'white', fontSize: '3rem', fontFamily: 'Roboto', fontWeight: '400', wordBreak: 'break-word' }}>{images[currentImage].text1}</p>
        <p style={{ color: 'white', fontSize: '1.5rem', fontFamily: 'Caladea', wordBreak: 'break-word' }}>{images[currentImage].text2}</p>
        <div className="flex">
          <motion.button
            as="a"
            href="/"
